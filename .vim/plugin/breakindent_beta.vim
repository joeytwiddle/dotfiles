...
" commands.  You will need to move onto a wrapped line to trigger an update.
"
...
"   :let g:breakindent_symbol = ' | '     " Try a clear continuation symbol
...
"
" Good news.  The real breakindent patch is being kept up-to-date at: https://retracile.net/wiki/VimBreakIndent   (Look for the "Original Format" link at the bottom of the page)
